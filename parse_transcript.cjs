    ...
    try {
      ...
      if (parsed.tool_calls) {
        for (const call of parsed.tool_calls) {
          if ((call.name === 'replace_file_content' || call.name === 'multi_replace_file_content') && call.args && call.args.TargetFile && call.args.TargetFile.includes('Hero.jsx')) {
            console.log("Found edit for Hero.jsx:");
